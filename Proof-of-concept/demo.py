...
def main(image_path):
    MODEL_PATH = os.path.join(Config.MODELS_DIR, "caption_model_checkpoint.keras") # "caption_model.keras") # "caption_model_checkpoint_early_stopping.keras")
    TOKENIZER_PATH = os.path.join(Config.WORKING_DIR, "tokenizer.pkl")
